...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    pluginRecoveryInstructions: 'Update or uninstall the failed third-party plugins in R9, then restart the app.',
    openTerminal: 'Open R9',
    restart: 'Restart deepseek harness',
    dismiss: 'Dismiss',
    updateAvailableTitle: 'deepseek harness Update Available',
    updateAvailableMessage: version => `deepseek harness ${version} is available.`,
    ...
    upToDateTitle: 'deepseek harness Is Up to Date',
    ...
    updateDownloadedTitle: 'deepseek harness Update Downloaded',
    updateReady: version => `deepseek harness ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace deepseek harness in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart deepseek harness and run the installer now?',
    ...
    updateInstalled: version => `deepseek harness ${version} has been installed.`,
    ...
    terminalErrorTitle: 'Unable to Open R9',
  ...
  zh: {
    ...
    pluginRecoveryInstructions: '请在 R9 中更新或卸载加载失败的第三方插件，然后重启应用。',
    openTerminal: '打开 R9',
    restart: '重启 deepseek harness',
    dismiss: '关闭',
    updateAvailableTitle: 'deepseek harness 有可用更新',
    updateAvailableMessage: version => `deepseek harness ${version} 已可用。`,
    ...
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'deepseek harness 已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: 'deepseek harness 更新已下载',
    updateReady: version => `deepseek harness ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 deepseek harness，然后重新打开。',
    windowsInstallQuestion: '现在重启 deepseek harness 并运行安装程序？',
    ...
    updateInstalled: version => `deepseek harness ${version} 已安装。`,
    removeInstallerQuestion: path => `是否删除下载的安装包以释放磁盘空间？\n\n${path}`,
    deleteInstaller: '删除安装包',
    keepInstaller: '保留安装包',
    terminalErrorTitle: '无法打开 R9',
