...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    profile: 'Profile',
    welcomeTitle: 'Welcome to deepseek harness',
    ...
    communityMarketBody: 'The open market built into deepseek harness, including custom data sources.',
    ...
    startUsing: 'Start using deepseek harness',
  ...
  zh: {
    ...
    profile: 'Profile',
    welcomeTitle: '欢迎使用 deepseek harness',
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'deepseek harness 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
