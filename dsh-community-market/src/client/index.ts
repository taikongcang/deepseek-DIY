...
export function apply(ctx: ClientContext): void {
  ...
  // DIY: the settings > plugins > "market" tab is intentionally NOT registered here.
  // The sidebar footer action below (plus its shell overlay) is the single market entry;
  // showing it twice was redundant. MarketSettingsTab.tsx itself is kept untouched because
  // it defines MarketSurface, which MarketOverlay renders.
